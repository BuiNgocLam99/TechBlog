            ...
            <div class="row">
                                ...
                                @foreach ($relate as $item)
                                    <div class="col-lg-6">
                                        <div class="blog-box">
                                            ...
                                            <div class="blog-meta">
                                                <h4><a href="{{ route('web.post', $item->slug) }}"
                                                        title="">{{ $item->title }}</a></h4>
                                                <small>{{ \Carbon\Carbon::parse($item->create_at)->format('d-m-Y') }}</small>
                                            ...
                                            <div class="media">
                                                <div class="media-body">
                                                    <h4 class="media-heading user_name">{{ $comment->user->name }}
                                                        <small>{{ \Carbon\Carbon::parse($comment->create_at)->format('d-m-Y') }}</small>
                                                    </h4>
                                                    <p>{{ $comment->content }}</p>
                                                </div>
                                            </div>
                ...
                <div class="col-lg-3 col-md-12 col-sm-12 col-xs-12">
                    <div class="sidebar">
                        ...
                        <div class="widget">
                            <h2 class="widget-title">Trend Posts</h2>
